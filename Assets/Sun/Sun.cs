...
namespace Entropedia
{
    ...
    {
        [SerializeField]
        float longitude = 78.4867f;
        [Range(1, 12)]
        public int month = 1;
        [SerializeField]
        float latitude = 17.3850f;
        ...
        private void Awake()
        {
            ...
            time = new DateTime(year: 2020, month: month, day: day, hour: hour, minute: 1, second: 1);
        ...
        private void OnValidate()
        {
            ...
            Debug.Log("Editor changed Time " + time.ToLongDateString() + " ,,, " + time.ToLongTimeString());
            Update();
        }
        ...
        if( light != null)    light.intensity = Mathf.InverseLerp(-12, 0, angles.x)*1.2f;
        }
